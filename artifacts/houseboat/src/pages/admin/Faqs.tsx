  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const res = editingId !== null
        ? await fetch(`${API}/faqs/${editingId}`, { method: "PATCH", headers: { "Content-Type": "application/json" }, body: JSON.stringify(payload) })
        : await fetch(`${API}/faqs`, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(payload) });
